<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-mk-text">Isi Saldo Petty Cash</h2>
                <div class="text-xs text-mk-muted mt-0.5">Owner — masuk laporan P&L</div>
            </div>
    ...
    <div class="py-6 px-4 lg:px-8">
        <div class="bg-mk-card shadow-sm sm:rounded-lg p-6 max-w-2xl">
            <form method="POST" action="{{ route('petty-cash.topups.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="topup_date" required
                           value="{{ old('topup_date', now()->toDateString()) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="description" required maxlength="255"
                           ...
                           placeholder="Contoh: Isi saldo petty cash Juni 2026"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="amount" required min="1" max="999999999"
                           value="{{ old('amount') }}"
                           placeholder="500000"
