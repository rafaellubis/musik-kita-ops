<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl">Laporan Keuangan — {{ $monthName }}</h2>
            <div class="flex items-center gap-3">
                {{-- Navigasi bulan --}}
                <form method="GET" action="{{ route('reports.finance') }}" class="flex items-center gap-2">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 border-b">
                    <h3 class="font-semibold text-sm">Ringkasan P&L — {{ $monthName }}</h3>
                </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 border-b flex justify-between">
                    <h3 class="font-semibold text-sm">Pendapatan per Jenis</h3>
                    <span class="text-sm font-semibold text-green-700">
                        Rp {{ number_format($totalRevenue, 0, ',', '.') }}
                    </span>
                </div>
                <div class="p-4 space-y-1 text-sm">
                    <div class="flex justify-between text-xs text-gray-500 uppercase border-b pb-1 mb-2">
                        <span>Jenis</span>
                        <div class="flex gap-8">
                            <span class="text-center w-20">Metode</span>
                            <span class="text-right w-32">Jumlah</span>
                        </div>
                    </div>

                    {{-- Breakdown per metode untuk bulan ini --}}
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 border-b flex justify-between">
                    <h3 class="font-semibold text-sm">Honor Guru</h3>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 border-b flex justify-between">
                    <h3 class="font-semibold text-sm">Pengeluaran per Kategori</h3>
