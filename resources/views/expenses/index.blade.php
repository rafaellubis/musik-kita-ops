<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl">Pengeluaran & Kas — {{ $monthName }}</h2>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                @if($expenses->isEmpty())
                    <div class="p-8 text-center text-gray-500">
                        ...
                        @hasanyrole('Owner|Admin')
                            <a href="{{ route('expenses.create') }}" class="mt-2 inline-block text-indigo-600 hover:underline text-sm">
