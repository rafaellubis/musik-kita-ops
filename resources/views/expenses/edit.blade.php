<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl">Edit Pengeluaran — {{ $expense->expense_number }}</h2>
            <a href="{{ route('expenses.show', $expense) }}" class="text-sm text-gray-600 hover:underline">
                ← Kembali
            </a>
        </div>
    </x-slot>
