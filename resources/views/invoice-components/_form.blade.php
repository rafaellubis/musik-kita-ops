...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        ...
        <p class="text-xs text-mk-dim mt-1">Huruf besar, angka, underscore. Contoh: BUKU, KOSTUM_KIDS</p>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="number" name="default_price" required min="0" max="99999999"
               ...
               class="mt-1 block w-full border-mk-border rounded-md"
               placeholder="100000">
        <p class="text-xs text-mk-dim mt-1">Bisa diubah saat input ke invoice murid.</p>
    </div>
    <div>
        ...
        <input type="number" name="sort_order" required min="0" max="999"
               ...
               class="mt-1 block w-full border-mk-border rounded-md">
        <p class="text-xs text-mk-dim mt-1">Angka kecil = tampil lebih atas di dropdown.</p>
    </div>
    <div class="md:col-span-2">
        ...
        <p class="text-xs text-mk-dim mt-1">Tidak tampil di invoice murid, hanya untuk referensi internal.</p>
    </div>
