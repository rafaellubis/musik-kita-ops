...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            $this->recreateSqliteTable(self::STATUS_WITH_CANCELLED);
            return;
        }
    ...
    {
        if (DB::getDriverName() === 'sqlite') {
            $this->recreateSqliteTable(self::STATUS_WITHOUT_CANCELLED);
            return;
        }
