 ...
 *
 * Kolom package_id, assigned_teacher_id, assigned_room_id,
 * preferred_day, preferred_time sudah DIHAPUS dari tabel students
 * (migrasi multi-kelas). Data tersebut kini ada di tabel enrollments.
 *
